...
$dbase_insert = "UPDATE `web_user` SET `status`='1' WHERE `email`='$email'";
...
<?php include"includes/header.php";?>
  ...
  <br>
    <h1 style="color:#313E47;">Email Verification Success</h1>
    <div class="clearfix"></div>
  <p style="color: #78d125; font-weight: 550; font-size: 18px;"><br>Your account has been activated sucessfully. you can login now &nbsp;&nbsp;<a href="<?php echo $site_path;?>login.php">Login</a></p><br>
